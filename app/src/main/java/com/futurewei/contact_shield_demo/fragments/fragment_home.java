...
public class fragment_home extends Fragment {
    ...
    void initView(View root){
        ...
        refresh_btn.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v){
                download_new downloadThread = new download_new(getContext(), myHandler);
                downloadThread.start();
//                try{
//                    Log.d("current thread", Thread.currentThread().getName());
//                    downloadThread.join();
//                }catch(Exception e){
//                    Log.e("download_new", "join failed");
//                }
//                getContactSketch();
    ...
    void refresh_UI(){
        ...
        Log.e("number of hits", String.valueOf(sharedPreferences.getInt("number_of_hits",0)));
